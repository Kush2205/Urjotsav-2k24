...
import ul from '../assets/logo.jpg'
...
export default function Contact(props) {
    ...
    return (
        <div className='flex'>
            {/* this is for the urjotssav filling part */}

            <div className='md:w-1/2 w-auto mt-[200px] mx-9 '>
                <h1 className='w-[90%] text-white text-4xl font-bold mb-8 font-Megrim'>URJOTSAV</h1>
                {/* for the input  */}

                <form onSubmit={handleSubmit}>
                    <div>
                        <input type='text'  onChange={handleChange} name='name' required value={form.name} className='w-full p-4 bg-white bg-opacity-10 mb-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"' placeholder='NAME'></input>

                        <input type='text' onChange={handleChange} name='email' required value={form.email} className='w-full p-4 bg-white bg-opacity-10 mb-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"' placeholder='EMAIL ADDRESS'></input>

                        <input type='text' onChange={handleChange} name='phoneno' required value={form.phoneno} className='w-full p-4 bg-white bg-opacity-10 mb-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"' placeholder='PHONE NUMBER'></input>

                        <textarea type='text' onChange={handleChange} name='message' required value={form.message}
                            placeholder="MESSAGE"
                        ...
                        <button
                            ...
                            className="w-full p-4 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none mb-16">  {isLoading ? 'Sending...': 'Send Message'} 
            ...
            <div className="md:w-1/2 w-auto mt-[200px] bg-black bg-opacity-60 rounded-lg p-8 text-white ">
                ...
                <div className='flex flex-col items-start'>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' scale-[] w-full h-full' src={ankurImg} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' w-full h-full' src={khushiImg} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' w-full h-full' src={atulImg} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' w-full h-full' src={rishikaImg} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' scale-[] w-full h-full' src={shubh} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' scale-[] w-full h-full' src={anmol} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' scale-[] w-full h-full' src={nishant} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' w-full h-full' src={ayushImg} />
                        </div>
                        <div>
                    ...
                    <div className=" flex items-center mb-6">
                        <div className=" w-20 h-20 bg-gray-500 rounded-full mr-4 overflow-hidden">
                            <img className=' w-full h-full' src={arnavImg} />
                        </div>
                        <div>
