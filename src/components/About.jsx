        ...
        <div>
            ...
            <div className=' h-full border-[1px] border-[black] mt-20  bg-white bg-opacity-5  '>
                ...
                <div className='border-[2px] border-double border-[#36A6BF] '>
                    <h1 className='text-8xl text-center text-[#36A6BF]  font-serif ' style={{ backgroundImage: `url(${background})`, backgroundSize: "cover", backgroundPosition: "center" }}>ABOUT RGIPT</h1>
                </div>
                ...
                <div className='w-80% p-5 mx-auto bg-opacity-10  h-full'>
            ...
            <div>
                <div className='w-[90%] mx-auto rounded-lg border-[2px] border-double shadow-xl border-[#36A6BF]'>
                    <h1 className='text-8xl text-center text-[#36A6BF]  font-serif ' style={{ backgroundImage: `url(${background})`, backgroundSize: "cover", backgroundPosition: "center" }}> ABOUT URJOTSAV</h1>
                </div>

                <div className=' p-5 mx-auto bg-opacity-10  h-full'>
                    <h1 className= 'w-[85%] px-4 mx-auto  text-[15px] mb-5 text-[#5CE3F2] text-center font-thin font-serif tracking-tight leading-loose backdrop-brightness-75 rounded-lg '>
                    ...
                    <h1 className='w-[85%] px-4 mx-auto text-[17px] text-center font-thin font-serif tracking-tight leading-loose text-[#5CE3F2] mb-5 backdrop-brightness-75'>
