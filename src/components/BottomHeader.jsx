...
export default function BottomHeader(props) {
    return (
        <>
            <div className='flex justify-between w-full fixed bottom-0 z-[1000]'>
                <div className='flex bg-gradient-to-t from-black to-transparent opacity-[0.7] rounded-r-full px-5 items-center text-white justify-evenly w-full h-16' >
                   <Link to="Ambassadors"><div className='relative group hover:scale-[1.2] transition-all'>Ambassador</div></Link> 
                   <Link to="Sponsors"><div className='relative group hover:scale-[1.2] transition-all'>Sponsors</div></Link> 
                </div>

                <div className='w-40' />

                <div className='flex bg-gradient-to-t from-black to-transparent rounded-l-full px-5 items-center text-white justify-evenly w-full h-16' >
                <div className='transition-all  hover:scale-[1.2] font-Jost'>
