    ...
    return (
        <>
            ...
            <Carousel showThumbs={false} infiniteLoop useKeyboardArrows={true} className='px-4' >
                <div className="flex flex-col items-center md:flex-row justify-center md:mx-10 gap-8 lg:gap-x-20 py-8">
                ...
                <div className="flex flex-col items-center md:flex-row justify-center gap-8 md:mx-10 lg:gap-x-20 py-8">
