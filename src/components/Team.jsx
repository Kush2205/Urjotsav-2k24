...
const teamMembers = [
  {
    ...
    position: "Head",
    mail: "22ce3008@rgipt.ac.in",
    imgSrc: "/heads/Event&Competition/anish.jpeg",
  },
  ...
  // { id: 5,name:'', role: 'Event Management Team',position:'',mail:'mail', imgSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXLb3TY72rHh4VSJUR8UGa83p3ABg3FRBNrw&s' },
  {
    ...
    role: "Technical Team",
    position: "Head",
    mail: "22cs3021@rgipt.ac.in",
    imgSrc: "heads/Technical/Ayush.jpg",
  },
  {
    id: 7,
    name: "Kushagra Kumar",
    ...
    mail: "23cs3037@rgipt.ac.in",
    imgSrc: "heads/Technical/Kushagra.jpg",
  },
  {
    id: 8,
    name: "Anshumaan Tanwar",
    role: "Technical Team",
    position: "Coordinator",
    mail: "23mc3009@rgipt.ac.in",
    imgSrc: "heads/Technical/Anshumaan.png",
  },
  {
    id: 9,
    name: "Aditya Narayan",
    role: "Technical Team",
    position: "Coordinator",
    mail: "23cs2007@rgipt.ac.in",
    imgSrc: "heads/Technical/Aditya.jpg",
  },
  {
    id: 10,
    name: "Mayank Kumar",
    role: "Technical Team",
    position: "Coordinator",
    mail: "23cs3038@rgipt.ac.in",
    imgSrc: "heads/Technical/Mayank.png",
  },
  {
    id: 11,
    ...
    position: "Head",
    mail: "22cs2021@rgipt.ac.in",
    imgSrc: "heads/Hospitality/sayan.jpeg",
  },
  ...
  // { id: 15,name:'name', role: 'Hospitality Team',position:'Head',mail:'mail', imgSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXLb3TY72rHh4VSJUR8UGa83p3ABg3FRBNrw&s' },
  {
    ...
    role: "Designing Team",
    position: "Head",
    mail: "22it3009@rgipt.ac.in",
    imgSrc: "heads/Designing/ArnavSao_DesigningHead_22it3009@rgipt.ac.in.png",
  },
  {
    id: 17,
    name: "Rishabh Kumar",
    role: "Designing Team",
    position: "Head",
    mail: "22cs3047@rgipt.ac.in",
    imgSrc: "heads/Designing/Rishabh_Kumar_Designing _22cs3047.jpg",
  },
  {
    id: 21,
    name: "Anubhuti Shriyas",
    role: "Editorial Team",
    position: "Head",
    mail: "22ce3011@rgipt.ac.in",
    imgSrc: "heads/Editorial/anubhuti.jpeg",
  },
  ...
  // { id: 26,name:'name', role: 'Editorial Team',position:'Head',mail:'mail', imgSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXLb3TY72rHh4VSJUR8UGa83p3ABg3FRBNrw&s' },
  {
    ...
    role: "Technical Team",
    position: "Coordinator",
    mail: "23cs2028@rgipt.ac.in",
    imgSrc: "heads/Technical/Maana1.jpg",
  },
  ...
  // },
  {
    ...
    role: "Sponsorship Team",
    position: "Head",
    mail: "22cs3042@rgipt.ac.in",
    imgSrc: "heads/Sponsorship/Nishant Nischal_Sponsership Head_22CS3042.jpg",
  },
  {
    id: 27,
    ...
    role: "Sponsorship Team",
    position: "Head",
    mail: "22ce3010@rgipt.ac.in",
    imgSrc: "heads/Sponsorship/Anmol_Shrivastava.jpg",
  },
  {
    id: 27,
    name: "Himanshu Jayant",
    role: "Creativity Team",
    position: "Head",
    mail: "22it3015@rgipt.ac.in",
    imgSrc: "heads/Creativity/HIMANSHU_JAYANT.jpeg",
  },
  {
    id: 27,
    name: "Yash Verma",
    role: "Creativity Team",
    position: "Head",
    mail: "22it3059@rgipt.ac.in",
    imgSrc: "heads/Creativity/IMG_20240610_211657.jpg",
  },
  {
    id: 27,
    name: "Prince Kumar",
    role: "Logistics Team",
    position: "Head",
    mail: "22ce3054@rgipt.ac.in",
    imgSrc: "heads/Logistics/Prince.jpg",
  },
  {
    id: 27,
    name: "Ritik Raushan",
    role: "Logistics Team",
    position: "Head",
    mail: "22ce3044@rgipt.ac.in",
    imgSrc: "heads/Logistics/Ritik.jpg",
  },
  {
    id: 27,
    name: "Anshu Priya",
    role: "Outreach Team",
    position: "Head",
    mail: "22cs2020@rgipt.ac.in",
    imgSrc: "heads/Outreach/Anshu.jpg",
  },
  {
    id: 27,
    name: "Aditya Kashyap",
    role: "Outreach Team",
    position: "Head",
    mail: "22ce3005@rgipt.ac.in",
    imgSrc: "heads/Outreach/arham.jpg",
  },
  // { id: 27,name:'Aditya Kumar', role: 'Photos and Videography Team',position:'Head',mail:'abc@rgipt.ac.in', imgSrc: 'heads/Photo&Videography/Aditya_Kumar.jpg' },
  {
    id: 27,
    name: "Ujjwal Kumar",
    role: "Photos and Videography Team",
    position: "Head",
    mail: "22cs3064@rgipt.ac.in",
    imgSrc: "heads/Photo&Videography/image.png",
  },

  {
    ...
    position: "Head",
    mail: "22cs3073@rgipt.ac.in",
    imgSrc: "heads/fest-coordinator/ankur.jpg",
  },
  {
    id: 27,
    name: "Atul Panwar",
  ...
  },
  {
    ...
    role: "Event Organizers",
    position: "Head",
    mail: "22it3002@rgipt.ac.in",
    imgSrc: "heads/eventorganizers/aditya.jpg",
  },
  {
    id: 27,
    name: "Arnav Sao",
    ...
    position: "Head",
    mail: "22it3009@rgipt.ac.in",
    imgSrc: "heads/eventorganizers/arnav.jpg",
  },

  {
    ...
    position: "Head",
    mail: "22it3010@rgipt.ac.in",
    imgSrc: "heads/socialmedia/aryan.jpg",
  },
];
            ...
            .map((member) => (
              ...
              >
                ...
                <div className="relative flex items-center transition-all duration-500 ease-in-out -translate-x-[6rem] sm:translate-x-[0] sm:group-hover:-translate-x-[4rem] lg:group-hover:-translate-x-[8rem]">
                  ...
                  <div
                    className={`min-w-[200px] absolute z-0 top-1/2 left-[-1rem] transform -translate-y-1/2 
                scale-100 opacity-100 sm:opacity-0 sm:scale-0 
                ...
                {/* Name displayed below the image */}
                <div
                  className={`mt-2 text-center text-white text-[0rem] sm:text-[1.5rem] opacity-100 transition-all duration-500 ease-in-out transform group-hover:translate-y-[-4rem] group-hover:opacity-0 hidden sm:block`}
                >
                  {member.name}
                </div>
              </div>
      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 sm:gap-y-12 gap-8 sm:gap-6 justify-evenly mt-10 mb-12 transition-all duration-500 ease-in-out">
          {teamMembers
            .filter(
              (member) =>
                member.role === "Hospitality Team" && member.position === "Head"
            )
            .map((member) => (
              <div
                key={member.id}
      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 sm:gap-y-12 gap-8 sm:gap-6 justify-evenly mt-10 mb-12 transition-all duration-500 ease-in-out">
          {teamMembers
            .filter(
              (member) =>
                member.role === "Editorial Team" && member.position === "Head"
            )
            .map((member) => (
              <div
                key={member.id}
          ...
          {teamMembers
            ...
            .map((member) => (
              ...
              >
                ...
                {/* Name displayed below the image, hidden on mobile screens */}
                <div
                  className={`mt-2 text-center text-white text-[0rem] sm:text-[1.5rem] opacity-100 transition-all duration-500 ease-in-out transform group-hover:translate-y-[-4rem] group-hover:opacity-0 hidden sm:block`}
                >
                  {member.name}
      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 sm:gap-y-12 gap-8 sm:gap-6 justify-evenly mt-10 mb-12 transition-all duration-500 ease-in-out">
          {teamMembers
            .filter(
              (member) =>
                member.role === "Photos and Videography Team" &&
                member.position === "Head"
            )
            .map((member) => (
              <div
