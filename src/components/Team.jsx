...
const teamMembers = [
  { id: 1,name:'Rishika Srivastava', role: 'Event Management Team', position:'Head',mail:'22it3039@rgipt.ac.in', imgSrc:'/heads/Event&Competition/Rishika Srivastava_Event head_22it3039.jpg' },
  ...
  { id: 6,name:'Ayush Tripathi', role: 'Technical Team',position:'Head',mail:'23cs3021@rgipt.ac.in', imgSrc: 'heads/Technical/Ayush.jpg' },
  ...
  { id: 11,name:'Harshit Viskarma', role: 'Hospitality Team',position:'Head',mail:'22ce3023@rgipt.ac.in', imgSrc: 'heads/Hospitality/Harshit.png' },
  ...
  { id: 21,name:'Sudhanshu Singh', role: 'Editorial Team',position:'Head',mail:'22cs3060@rgipt.ac.in', imgSrc: 'heads/Editorial/SudhanshuSingh_DocumentationHead_22cs3060.JPG' },
  ...
  { id: 27,name:'Nishant Nischal', role: 'Sponsorship Team',position:'Coordinator',mail:'22cs3042@rgipt.ac.in', imgSrc: 'heads/Sponsorship/Nishant Nischal_Sponsership Head_22CS3042.jpg' },
  { id: 27,name:'Raghav Dixit', role: 'Sponsorship Team',position:'Coordinator',mail:'22ce3043@rgipt.ac.in', imgSrc: 'heads/Sponsorship/Raghav Dixit.jpg' },
  ...
  { id: 27,name:'name', role: 'Creativity Team',position:'Head',mail:'23cs2028@rgipt.ac.in', imgSrc: 'heads/Creativity/IMG_20240610_211657.jpg' },
  ...
  { id: 27,name:'Mohd Arham', role: 'Outreach Team',position:'Head',mail:'22ce3032@rgipt.ac.in', imgSrc: 'heads/Outreach/arham.jpg' },
  ...
  { id: 27,name:'Abc', role: 'Photos and Videography Team',position:'Head',mail:'abc@rgipt.ac.in', imgSrc: 'heads/Photo&Videography/image.png' },
...
<h1 className="font-Megrim text-center text-white text-[35px] sm:text-[30px] lg:text-[50px]  tracking-[1px] sm:tracking-[2px] lg:tracking-[3.12px] break-words flex h-[140px] sm:h-[180px] lg:h-[10px] flex-col justify-center shrink-0 mt-0 mb-20 ">
    ...
    {teamMembers
      ...
      .map((member, index, array) => (
        ...
        >
          ...
          <div className={`relative flex items-center transition-all duration-500 ease-in-out group-hover:-translate-x-[4rem] sm:group-hover:-translate-x-[4rem] lg:group-hover:-translate-x-[8rem]`}>
  <div className="z-10">
  ...
  <div className={`min-w-[200px] absolute z-0 top-1/2 left-0 transform -translate-x-[4rem] sm:-translate-x-[5rem] lg:-translate-x-[5rem] -translate-y-1/2 opacity-0 scale-0 
