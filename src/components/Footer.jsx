...
<div className="w-[100vw] flex items-center justify-center inset-0 bg-white bg-opacity-10 backdrop-blur-md">
        <div className="md:w-[90%] w-full px-4 text-white flex flex-col">
            ...
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                ...
                <div className="flex mb-6 mt-4 px-[15px] md:px-1 flex-row items-end justify-between">
                    <div className="">
                    <div className=" transition-all hover:scale-110 font-Jost logo w-[50px] h-[70px] md:w-[70px] md:h-[100px]">
              
            </div>
                    </div>
                    
                    <a href="/" className="hidden md:block cursor-pointer text-white-400 hover:text-white uppercase transition-all hover:scale-110 font-Jost ">Home</a>
                    <a href="/about2" className="hidden md:block cursor-pointer text-white-400 hover:text-white uppercase transition-all hover:scale-110 font-Jost">About Us</a>
                    <a href='/events' className="hidden md:block cursor-pointer text-white-400 hover:text-white uppercase transition-all hover:scale-110 font-Jost">Events</a>
                    <a href="/contact" className="hidden md:block cursor-pointer text-white-400 hover:text-white uppercase transition-all hover:scale-110 font-Jost">Contact</a>
                ...
                <p className="w-full text-center my-12 text-white-600">Copyright ©️ Urjotsav 2024</p>
