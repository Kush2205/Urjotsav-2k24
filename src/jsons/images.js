...
import bg5 from "../assets/Images/image5.png";
   const bgimages = {1: bg3, 2: bg4, 3: bg1, 4: bg4, 5: bg5};
   const images = {1: bg3, 2: bg4, 3: bg1, 4: bg4, 5: bg5};
   
   export default {bgimages, images};
